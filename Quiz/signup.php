<html>
  ...
  <head>
    ...
    <script>
      ...
      {
        var input=document.getElementById('t8');
        input.type = "number"
      }
	...
	<body onload="lfun()" style="background:url(images/web.jpg);">
		...
		<div id="lgin" style="transition: all 0.8s ease;opacity:0;">
    ...
    <input type="submit" class="logbut" id="lgbut" value="Sign in" onclick="fun2(),valid1()">
		...
		<div id="sgin" style="transition: all 0.8s ease; opacity:1;">

    <form action="processsignup.php" method="post" onsubmit="return validation2()">
		<i id="4" class="up fa fa-envelope-o" style="top:215px;"></i>
		<input type="email" value="Enter valid email" name="email" class="txt" id="t4" style="top:215px;" onfocus="eef(this.value);" onblur="eeb(this.value);"/>
    ...
    <input type="text" value="Your team name" class="txt" name="name" id="t7" style="top:390px;" onfocus="colf(this.value);" onblur="colb(this.value);"/>
    ...
    <input type="text" value="Your phone number" class="txt" name="phone" id="t8" style="top:450px;" onfocus="phf(this.value);changeType2();" onblur="phb(this.value);"/>
    <i class="up1 fa fa-info-circle" style="top:450px;" title="Enter your phone number"></i>

		<p class="vld" id="valid2" style="top:475px"><?php if($_GET) print $_GET["err2"];?></p>
		</div>
